...
public class Exam_File {
	...
	public static void main(String[] args) throws IOException {
		File folderMake = new File("src/org/Jeonom/day15/stream/file/sample");
	...
	public void fileMake() throws IOException {
		File fileMake = new File("src/org/Jeonom/day15/stream/file/sample.txt");
		if(!fileMake.exists()) {
	...
	public void fileBasic() {
		...
		// file을 객체화해서 파일의 메소드를 사용하는 것이 file 클래스
