package org.Jeonom.day12.collection.set;

import java.util.HashSet;
import java.util.Iterator;
import java.util.Set;

import org.Jeonom.day12.collection.student.Student;
...
public class Exam_SetCollection {
	...
	public static void main(String[] args) {
		...
		// 자료구조의 특성에 따라서 선택하여 사용한다.
		// Set 순서는 중요하지 않으며, 중복을 허용하지 않음
		// -> 중복을 제거할 수 있음
	...
	public void setSample() {
		...
		// 중복을 허용하지 않는 것 -> 복권당첨번호, 주민등록번호, 변수이름, ...
		// 수학의 집합 : 순서가 중요하지 않음, 중복을 허용하지 않음.
		// 중복이 있는 데이터들을 set에 넣으면 중복이 제거됨.
		// 순서가 있는 경우(ArrayList)에는 index활용할 수 있으나 set처럼 순서가 없으면 지시자 활용
